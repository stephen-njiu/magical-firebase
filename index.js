...
// const textareaEl = SUNEDITOR.create('post-input', {
//         height: 300,
//         plugins: ['font', 'fontSize', 'formatBlock', 'align', 'list', 'link', 'image', 'video', 'emoji'], // Emoji support!
//         buttonList: [
//             ['font', 'fontSize', 'formatBlock', 'bold', 'underline', 'italic', 'strike'],
//             ['fontColor', 'hiliteColor', 'align', 'list', 'link', 'image', 'video', 'emoji']
//         ]
//     })

    // Retrieve HTML content when the button is clicked
    // document.getElementById('post-btn').addEventListener('click', () => {
    //     const postContent = textareaEl.getContents(); // Get the HTML content
    //     console.log(postContent); // Log it or send it to your database
    // });

// const textareaEl = quill.root.innerHTML
...
// const quill = new Quill('#post-input', {
//     theme: 'snow'
// });
...
function showProfilePicture(imgElement, user) {
    ...
    if (photoURL) {
        ...
        // imgElement.src = "assets/emojis/5.jpg"
        imgElement.src = `assets/emojis/${Math.floor(Math.random() * 4) + 2}.jpg`;
